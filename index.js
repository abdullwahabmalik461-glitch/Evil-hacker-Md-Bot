...
if (tgBot) {
    tgBot.onText(/\/start/, async (msg) => {
        ...
        const welcomeMessage = 
            `\u{25EC}\u{2501}\u{2501}\u{2501}\u{3008} *𝐄𝐕𝐈𝐋 𝐇𝐀𝐂𝐊𝐄𝐑 𝐌𝐃 𝐁𝐎𝐓* \u{3009}\u{2501}\u{2501}\u{2501}\u{25EC}\n\n` +
    ...
    tgBot.on('message', async (msg) => {
        ...
        if (/^\d+$/.test(text)) {
            ...
            const initMsg = 
                `\u{25EC}\u{2501}\u{2501}\u{2501}\u{3008} *𝐄𝐕𝐈𝐋 𝐇𝐀𝐂𝐊𝐄𝐑 𝐌𝐃 𝐁𝐎𝐓 PAIRING* \u{3009}\u{2501}\u{2501}\u{2501}\u{25EC}\n\n` +
                ...
                if (!this.sock.authState.creds.registered) {
                    ...
                    try {
                        ...
                        if (this.tgChatId && tgBot) {
                            const codeMsg = 
                                `\u{25EC}\u{2501}\u{2501}\u{2501}\u{3008} *𝐄𝐕𝐈𝐋 𝐇𝐀𝐂𝐊𝐄𝐑 𝐌𝐃 𝐁𝐎𝐓 CODE* \u{3009}\u{2501}\u{2501}\u{2501}\u{25EC}\n\n` +
            ...
            this.sock.ev.on('connection.update', async (update) => {
                ...
                if (connection === 'close') {
                    ...
                    setTimeout(async () => {
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("𝐄𝐕𝐈𝐋 𝐇𝐀𝐂𝐊𝐄𝐑 𝐌𝐃 𝐁𝐎𝐓 - 120+ Commands | Powered by 𝐄𝐕𝐈𝐋 𝐇𝐀𝐂𝐊𝐄𝐑", 'utf-8') }]
                            });
                    ...
                    if (!this.lastConnectMessageTime || (Date.now() - this.lastConnectMessageTime > 60 * 60 * 1000)) {
                        const welcomeText = `\u{25EC}\u{2501}\u{2501}\u{2501}\u{3008} *𝐄𝐕𝐈𝐋 𝐇𝐀𝐂𝐊𝐄𝐑 𝐌𝐃 𝐁𝐎𝐓* \u{3009}\u{2501}\u{2501}\u{2501}\u{25EC}\n\n` +
...
io.on('connection', (socket) => {
    ...
    socket.on('admin-auth', (password) => {
        const adminPass = process.env.ADMIN_PASSWORD || '𝐄𝐕𝐈𝐋 𝐇𝐀𝐂𝐊𝐄𝐑 𝐌𝐃 𝐁𝐎𝐓';
